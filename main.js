...
const textEls = {
    ...
    metaHighlight: document.getElementById('meta-highlight'),
    ...
    stagesLead: document.getElementById('stages-lead'),
    hotTitle: document.getElementById('hot-title'),
    hotSubtitle: document.getElementById('hot-subtitle'),
    hotLead: document.getElementById('hot-lead'),
    aboutTitle: document.getElementById('about-title'),
    aboutSubtitle: document.getElementById('about-subtitle'),
    aboutMissionTitle: document.getElementById('about-mission-title'),
    aboutMissionText: document.getElementById('about-mission-text'),
    aboutEditorialTitle: document.getElementById('about-editorial-title'),
    aboutEditorialText: document.getElementById('about-editorial-text'),
    aboutSourcesTitle: document.getElementById('about-sources-title'),
    aboutSourcesText: document.getElementById('about-sources-text'),
    sourcesTitle: document.getElementById('sources-title'),
    sourcesSubtitle: document.getElementById('sources-subtitle'),
    ...
    privacyAds: document.getElementById('privacy-ads'),
    privacyLink: document.getElementById('privacy-link'),
    termsTitle: document.getElementById('terms-title'),
    termsSubtitle: document.getElementById('terms-subtitle'),
...
const translations = {
    en: {
        ...
        metaSources: 'Monthly essentials at a glance',
        metaHighlight: 'Milestones, at a glance',
        ...
        stagesLead: 'Each stage highlights the top essentials plus practical actions you can apply right away.',
        hotTitle: 'Parenting Themes',
        hotSubtitle: 'Play, learning, outings, and formula picks in one place.',
        hotLead: 'Browse themes for quick guidance on common challenges like sleep, feeding, and play.',
        aboutTitle: 'About Mongle Map',
        aboutSubtitle: 'A practical, parent-first guide to key milestones from pregnancy to 36 months.',
        aboutMissionTitle: 'Our Mission',
        aboutMissionText: 'We turn complex parenting information into clear, actionable steps so families can focus on what matters most.',
        aboutEditorialTitle: 'Editorial Policy',
        aboutEditorialText: 'Content is created from public guidelines and expert sources, then summarized for clarity. We avoid medical diagnosis and encourage professional consultation for health decisions.',
        aboutSourcesTitle: 'Sources We Reference',
        aboutSourcesText: 'Guidance is informed by public health agencies and pediatric resources. We update summaries when key guidance changes.',
        sourcesTitle: 'Sources & References',
        sourcesSubtitle: 'We link to public health guidance and parent resources we rely on.',
        contactTitle: 'Contact',
        contactSubtitle: 'Questions or feedback? Reach us anytime.',
        contactText: 'Email: alsrb8586@gmail.com',
        contactNote: 'For business partnerships, use the form below.',
        ...
        privacySubtitle: 'We respect your data and keep collection to a minimum.',
        privacyText: 'We collect only what is needed to provide the service (such as form submissions). We do not sell personal information. We retain submissions only as long as needed to respond. Ad providers may use cookies or device identifiers to serve ads.',
        privacyAds: 'You can manage ad personalization in your browser or Google Ads settings.',
        privacyLink: 'Read the full Privacy Policy',
        termsTitle: 'Terms of Use',
        termsSubtitle: 'Please read before using the site.',
        termsText: 'This site provides general parenting information and does not replace professional medical advice. By using the site, you agree to use the content at your own discretion and verify product labels or guidance with professionals when needed.',
    ...
    ko: {
        ...
        metaSources: '월령별 핵심 체크포인트',
        metaHighlight: '우리 아기 성장 일정 한눈에',
        ...
        stagesLead: '각 구간의 핵심 준비물과 바로 적용할 수 있는 실전 포인트를 담았습니다.',
        hotTitle: '육아 테마',
        hotSubtitle: '놀이, 교육, 외출, 분유까지 한 번에.',
        hotLead: '수면, 수유, 놀이 등 자주 묻는 테마를 빠르게 확인하세요.',
        aboutTitle: '몽글맵 소개',
        aboutSubtitle: '임신부터 36개월까지, 부모가 바로 적용할 수 있는 핵심 가이드.',
        aboutMissionTitle: '미션',
        aboutMissionText: '복잡한 정보를 쉬운 단계로 정리해 부모가 중요한 순간에 집중하도록 돕습니다.',
        aboutEditorialTitle: '편집 원칙',
        aboutEditorialText: '공공 가이드와 전문가 자료를 바탕으로 요약하며, 의학적 진단은 하지 않습니다. 건강 관련 결정은 전문가 상담을 권장합니다.',
        aboutSourcesTitle: '참고 출처',
        aboutSourcesText: '공공 보건기관과 소아 관련 자료를 참고합니다. 주요 가이드가 변경되면 요약을 업데이트합니다.',
        sourcesTitle: '출처 및 참고',
        sourcesSubtitle: '공공 보건 가이드와 부모 참고 자료를 연결합니다.',
        contactTitle: '문의',
        contactSubtitle: '질문이나 피드백은 언제든지 연락주세요.',
        contactText: '이메일: alsrb8586@gmail.com',
        contactNote: '비즈니스 제휴는 아래 폼을 이용해주세요.',
        ...
        privacySubtitle: '최소한의 정보만 수집하고 안전하게 보호합니다.',
        privacyText: '서비스 제공에 필요한 정보(예: 폼 제출)만 수집하며, 개인정보를 판매하지 않습니다. 문의 응답에 필요한 기간만 보관합니다. 광고 제공자는 쿠키 또는 기기 식별자를 사용할 수 있습니다.',
        privacyAds: '광고 맞춤 설정은 브라우저 또는 Google 광고 설정에서 관리할 수 있습니다.',
        privacyLink: '개인정보 처리방침 전문 보기',
        termsTitle: '이용 약관',
        termsSubtitle: '이 사이트 이용 전 확인해주세요.',
        termsText: '이 사이트는 일반적인 육아 정보를 제공하며 전문 의료 조언을 대체하지 않습니다. 이용자는 스스로의 판단에 따라 콘텐츠를 활용하며, 필요 시 전문가와 제품 정보를 확인합니다.',
