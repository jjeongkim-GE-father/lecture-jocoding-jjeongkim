...
const translations = {
    en: {
        ...
        privacyText: 'We collect only what is needed to provide the service (such as form submissions). We do not sell personal information. Ad providers may use cookies or device identifiers to serve ads.',
        ...
        termsText: 'This site provides general parenting information and does not replace professional medical advice. By using the site, you agree to use the content at your own discretion.',
    ...
    ko: {
        ...
        privacyText: '서비스 제공에 필요한 정보(예: 폼 제출)만 수집하며, 개인정보를 판매하지 않습니다. 광고 제공자는 쿠키 또는 기기 식별자를 사용할 수 있습니다.',
        privacyAds: '광고 맞춤 설정은 브라우저 또는 Google 광고 설정에서 관리할 수 있습니다.',
        termsTitle: '이용 약관',
        termsSubtitle: '이 사이트 이용 전 확인해주세요.',
        termsText: '이 사이트는 일반적인 육아 정보를 제공하며 전문 의료 조언을 대체하지 않습니다. 이용자는 스스로의 판단에 따라 콘텐츠를 활용합니다.',
